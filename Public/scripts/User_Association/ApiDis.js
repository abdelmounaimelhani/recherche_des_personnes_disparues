...
async function Recherch(indi) {
    ...
    await fetch("http://127.0.0.1:5000/test", {
        ...
        body: JSON.stringify({"id": allParams.IDD,"hash": allParams.hash,"date": indi.date_N})
    })
    ...
    if (data.lenight) {
        ...
        titre.innerHTML="Résultats de la recherche pour personnes disparues"
...
BtnRES.addEventListener("click",()=>{
    titre.innerHTML="Veuillez patienter pendant la recherche de résultats similaires <span class='loaderdisp'></span>"
    get_info_indiv()
