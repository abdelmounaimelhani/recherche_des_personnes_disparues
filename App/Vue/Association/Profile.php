                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" type="text" value="<?=$ass->nom?>"
                                    placeholder="Nom">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" type="text" value="<?=$ass->adress?>"
                                    placeholder="Gennre">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" value="<?=$ass->email?>" type="email"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" value="<?=$ass->tele?>" type="text"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" value="<?=$ass->ville?>" type="text"
                                    placeholder="Ville">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nom</label>
                                    <input class="form-control" type="text" value="<?=$ass->nom?>" placeholder="Nom"
                                        name="Nom">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Adress </label>
                                    <input class="form-control" type="text" value="<?=$ass->adress?>" name="Adress"
                                        placeholder="Adress">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Email</label>
                                    <input class="form-control" value="<?=$ass->email?>" type="email" name="email"
                                        placeholder="Exomple@gmail.com">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Telephone</label>
                                    <input class="form-control" value="<?=$ass->tele?>" type="text" name="Tele"
                                        placeholder="0600000000">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Ville</label>
                                    <input class="form-control" value="<?=$ass->ville?>" type="text" name="Ville"
                                        placeholder="Ville">
                                </div>
                            </div>
                            <div class="col-6">
