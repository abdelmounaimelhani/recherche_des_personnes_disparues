                  ...
                  <div class="row">
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input disabled class="form-control" type="text" value="<?=$user->nom?>" placeholder="Nom">
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Prenom</label>
                        <input disabled class="form-control" type="text" value="<?=$user->prenom?>" placeholder="Prenom">
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Gennre</label>
                        <input disabled class="form-control" type="text" value="<?php if($user->genner=="H"){echo "Homme";}else{echo "Femme";}?>" placeholder="Gennre">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input disabled class="form-control" value="<?=$user->email?>" type="email" placeholder="Exomple@gmail.com">
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Telephone</label>
                        <input disabled class="form-control" value="<?=$user->tele?>" type="text" placeholder="0600000000">
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Ville</label>
                        <input disabled class="form-control" value="<?=$user->Ville?>" type="text" placeholder="Ville">
                      </div>
                    </div>
                  </div>
              </div>
